...
export const toJson = <T>(data: string) => JSON.parse(data) as T;
export const toText = <T extends object>(data: T) => JSON.stringify(data);
...
@Component({
  selector: 'contact-devices-configuration',
